...
const Header = () => {
  ...
  const navItems = [
    ...
    { path: '/why-this-works', label: 'Why This Works' },
          ...
          <nav className="hidden lg:flex items-center gap-6">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`text-sm font-medium ${isActive(item.path) ? 'text-[#111111]' : 'text-[#444444] hover:text-[#111111]'}`}
              >
                {item.label}
              </Link>
            ))}
                ...
                <Link
                  ...
                  className={`block px-4 py-2 text-sm font-medium ${
                    isActive(item.path)
                      ...
                      : 'text-[#444444] hover:text-[#111111] hover:bg-gray-50'
                  }`}
                >
                  {item.label}
                </Link>
