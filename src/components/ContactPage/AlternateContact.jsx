        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div className="card text-center">
            ...
            <a
              ...
              className="text-black hover:text-gray-700 font-semibold text-sm smooth-transition inline-block"
            >
              hello@martechadda.com
            </a>
          </div>
          ...
          <div className="card text-center">
            ...
            <h3 className="heading-3 mb-3">Follow Us</h3>
            <div className="flex justify-center items-center gap-3">
              <a
                href="https://linkedin.com"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-gray-200 hover:border-gray-300 text-black font-semibold text-xs smooth-transition"
              >
